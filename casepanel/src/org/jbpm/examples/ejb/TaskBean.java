...
public class TaskBean {
	...
	public Node[] getNodes(long processInstanceId) {
		RuntimeEngine runtime = taskSerbeanvice.getSingletonManager()
				.getRuntimeEngine(EmptyContext.get());
		KieSession ksession = runtime.getKieSession();
		ProcessInstance processInstance = ksession
				.getProcessInstance(processInstanceId);
		return ((org.jbpm.ruleflow.instance.RuleFlowProcessInstance) processInstance)
